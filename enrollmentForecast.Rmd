...
output: 
  html_notebook:
    ...
    toc_float:
      collapsed: false
---
The following script uses a client's digital marketing campaign, budget and student enrollment data to forecast student enrollments for the coming year.
```{r message =  FALSE}
# Libraries
library(caret)
library(skimr)
